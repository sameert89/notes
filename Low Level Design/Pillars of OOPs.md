...
| **Abstraction**   | Hiding complexity while showing only the essentials.                                                                                                                             | `class Shape { public: virtual void draw() = 0; }; // Pure virtual function`      |
...
| **Polymorphism**  | The ability of a single interface to represent different underlying forms (e.g., a function behaving differently based on the object calling it). Read [[Types of Polymorphism]] | `void sound() { cout << "Generic"; } void sound(int volume) { /* Overloaded */ }` |

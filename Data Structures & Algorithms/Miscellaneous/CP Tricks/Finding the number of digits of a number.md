...
> [!warning] This only works for $n\geq1 \forall n\in Z$
> This only works for such numbers because logarithm is not defined for numbers less than equal to zero. This is also not applicable on non integers
